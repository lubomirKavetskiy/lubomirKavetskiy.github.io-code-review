...
$.fn.dataTableExt.oPagination.ellipses = {
    ...
    'fnInit': function(oSettings, nPager, fnCallbackDraw) {
        ...
        var oFirst = $('<a class="' + oClasses.sPageButton + ' ' + oClasses.sPageFirst + ' '+'first'+'">' + oLang.sFirst + '</a>'),
            oPrevious = $('<a class="' + oClasses.sPageButton + ' ' + oClasses.sPagePrevious + ' '+'prev'+'">' + oLang.sPrevious + '</a>'),
            oNumbers = $('<span class="' + oClasses.sPageNumbers + '"></span>'),
            oNext = $('<a class="' + oClasses.sPageButton + ' ' + oClasses.sPageNext + ' '+'next'+'">' + oLang.sNext + '</a>'),
            oLast = $('<a class="' + oClasses.sPageButton + ' ' + oClasses.sPageLast + ' '+'last'+'">' + oLang.sLast + '</a>');
    ...
    'fnUpdate': function(oSettings, fnCallbackDraw) {
        ...
        if (oSettings._iCurrentPage === 1) {
            $('.first.' + oClasses.sPageFirst, tableWrapper).attr('disabled', true);
        ...
        if (oSettings._iTotalPages === 0 || oSettings._iCurrentPage === oSettings._iTotalPages) {
            ...
            $('.first.' + oClasses.sPageFirst, tableWrapper).removeAttr('disabled');
        } else {
